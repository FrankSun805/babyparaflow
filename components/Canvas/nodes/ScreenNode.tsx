...
export const ScreenNode: React.FC<ScreenNodeProps> = ({
  ...
  return (
    <div className="w-full h-full flex flex-col items-center">
      {/* Header / Actions Bar */}
      <div className="w-full flex items-center justify-between mb-2 px-1" style={{ maxWidth: width }}>
         <div className="flex items-center gap-2 min-w-0">
             <div className="w-8 h-8 bg-brand-100 text-brand-600 rounded-lg flex items-center justify-center shadow-sm shrink-0">
                 <Smartphone size={16} />
             </div>
             <div className="min-w-0">
                 <div className="text-[8px] font-bold text-slate-400 uppercase tracking-wider leading-none mb-0.5">Screen</div>
                 <h3 className="font-bold text-slate-900 text-xs leading-none truncate">{data.screenName}</h3>
             </div>
         </div>
         <div className="flex items-center gap-1.5 shrink-0">
            ...
            <button
                ...
                className="px-2 py-1.5 bg-brand-600 hover:bg-brand-500 text-white text-[10px] font-medium rounded-md transition-all flex items-center gap-1 shadow-md shadow-brand-600/20 whitespace-nowrap"
            >
